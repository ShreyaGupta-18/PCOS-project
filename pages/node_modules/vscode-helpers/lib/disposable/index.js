...
exports.usingSync = exports.using = exports.tryDisposeAndDelete = exports.tryDispose = exports.makeNonDisposable = exports.DisposableBase = exports.EVENT_DISPOSING = exports.EVENT_DISPOSED = void 0;
 ...
 */
async function using(obj, func, ...args) {
    try {
        return await Promise.resolve(func.apply(null, [obj].concat(args)));
    }
    finally {
        if (obj) {
            obj.dispose();
