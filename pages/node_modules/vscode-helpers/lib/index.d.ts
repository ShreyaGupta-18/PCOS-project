 ...
 */
export declare const QUEUE: PQueue<import("p-queue/dist/priority-queue").default, import("p-queue").DefaultAddOptions>;
/**
 ...
 */
export declare function asArray<T>(val: T | T[] | ReadonlyArray<T>, removeEmpty?: boolean): T[];
/**
 ...
 */
export declare function createQueue<TOpts extends QueueAddOptions = QueueAddOptions>(opts?: TOpts): PQueue<import("p-queue/dist/priority-queue").default, import("p-queue").DefaultAddOptions>;
/**
