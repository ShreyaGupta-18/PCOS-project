...
exports.waitWhile = exports.tryClearTimeout = exports.tryClearInterval = exports.startWatch = exports.sleep = exports.invokeAfter = exports.createTimeout = exports.createInterval = exports.StopWatch = void 0;
 ...
 */
async function waitWhile(predicate, opts) {
    if (!opts) {
        opts = {};
    }
    ...
    do {
        ...
        wait = vscode_helpers.toBooleanSafe(await Promise.resolve(predicate()));
        if (wait) {
